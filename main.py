...
@client.command()
async def bread(ctx):
    await ctx.send("Hi! I am omboybreads personal bot. For now I can`t do much and will probablly not respond to you. But I will probablly get improved! :)") #simple command so that when you type "!ping" the bot will respond with "pong!"
